...
local function downloadPremadeProfiles(commit)
    ...
    local success, response = pcall(function()
        return game:HttpGet('https://api.github.com/repos/onnation/onnation/contents/profiles/premade?ref=' .. commit)
    end)
...
if not shared.VapeDeveloper then
	...
	local ok, res = pcall(function()
		return game:HttpGet('https://api.github.com/repos/onnation/onnation/commits/main', true)
	end)
